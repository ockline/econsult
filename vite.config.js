...
//      'process.env.REACT_APP_API_BASE_URL': JSON.stringify('http://socratedevtest.esocrate.co.tz/api'),
//  'import.meta.env.VITE_REACT_APP_DOC_BASE_URL': JSON.stringify('http://socratedevtest.esocrate.co.tz'),
  },
  build: {
