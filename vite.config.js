...
export default defineConfig({
  ...
  define: {
    ...
    //  'process.env.REACT_APP_API_BASE_URL': JSON.stringify('https://socratepre-api.socrate.co.tz/api'),
    //  'import.meta.env.VITE_REACT_APP_DOC_BASE_URL': JSON.stringify('https://socratepre-api.socrate.co.tz'),
