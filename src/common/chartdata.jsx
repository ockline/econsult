...
export class NormalsOverView extends Component {
  constructor(props) {
    super(props);
...
export function NormalsValue() {
  return <Doughnut id='normal-donut' className="!h-[230px] mx-auto my-auto" data={data} options={options} width={230} height={230} />
}
...
export class OrderVsNormals extends Component {
  constructor(props) {
    super(props);
      ...
      <div className="box">
        <div className="box-header">
          <div className="sm:flex justify-between">
            <h5 className="box-title my-auto">Order Vs Normals</h5>
...
export class NFTNormalsOverview extends Component {
  constructor(props) {
    super(props);
...
//NormalsNormals Overview

export class NormalsOverviewHRM extends Component {
  constructor(props) {
    super(props);
...
export class SettingsRevenue extends Component {
  constructor(props) {
    super(props);
