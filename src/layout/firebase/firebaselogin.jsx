       ...
       <h1 className="text-lg"><b>SOCRATE MANAGEMENT SYSTEM (ESMS)</b></h1>
        ...
        <div class="grid md:grid-cols-2 items-center gap-8">
          ...
          <form class="md:max-w-md w-full mx-auto" onSubmit={handleSubmit}>
            ...
            <div>
              <div class="relative flex items-center">
                <input name="email" type="email"  value={state.email} onChange={changeHandler}
                                required   autoComplete="email" class="w-full text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
            ...
            <div class="mt-8">
              <div class="relative flex items-center">
                <input name="password" type="password"  value={state.password} onChange={changeHandler} required class="w-full text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
              ...
              <div>
            <Link className="text-blue-600 font-semibold text-sm hover:underline" to={`${import.meta.env.BASE_URL}Authentication/forgetpassword/cover1`}>Forgot password?</Link>
              </div>
            </div>
