    ...
    return (
        <div>
            ...
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Employee Induction Training</h1>
            ...
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    <h5 className="box-title my-auto text-lg">Employee Induction Training List </h5>
                                    ...
                                    currentEntries.map((employee, index) => (
                                        <tr className="product-list" key={employee.id}>
                                            ...
                                            <td className="text-end font-medium">
                                                ...
                                                <Link
                                                    aria-label="anchor"
                                                    to={`${import.meta.env.BASE_URL}employees/induction/show_induction_training/` + employee.id}
                                                ...
                                                <Link
                                                    aria-label="anchor"
                                                    to={`${import.meta.env.BASE_URL}employees/induction/edit_induction_training/` + employee.id}
