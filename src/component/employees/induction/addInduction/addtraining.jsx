 ...
 const [selected, setSelected] = useState([]);
  ...
  const [value, setValue] = useState([]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const resp = await axios.post(`${apiBaseUrl}/employees/add_employee`, DataToSend, {
                headers: {
    ...
    //Block to save Education && Employement history && Reference check
    ...
    const handleeducationChange = (selectedOption) => {
        ...
        setEducationData((prevData) => ({
            ...
            // graduation_year: selectedOption ? selectedOption.value : '', // Assuming value is what you want
        }));
    };

    const SaveEducationLevel = async (e) => {
        e.preventDefault();
        const educationData = {
        ...
        try {
            const res = await axios.post(`${apiBaseUrl}/employees/education_employee`, educationData, {
                headers: {
                    "Content-Type": "multipart/form-data"
                }
            });
    ...
    const [employment, setEmploymentData] = useState({
        company_name: '',
            from_date: '',
            to_date: '',
            position: '',
    ...
    const handleFileEmpInputChange = (fieldName, files) => {
        // const file = files[0]; // Assuming single file selection, update accordingly for multiple files
    ...
    const handleEmploymentInputChange = (stepName, value) => {
        if (value instanceof File) {
            // Handle file input change
            handleFileEmpInputChange(stepName, [value]);
        } else {
            // Handle other input types
            setEmploymentData((prevData) => ({
                ...prevData,
    ...
    const saveEmploymentHistory = async (e) => {
        e.preventDefault();
        ...
        try {
            const res = await axios.post(`${apiBaseUrl}/employees/employment_employee`, employmentData, {
                headers: {
                    "Content-Type": "multipart/form-data"
                }
            });
            if (res.data.validator_err) {
                ...
                swal({
                    title: 'Employment History added Successfully',
                    text: res.data.message,
                    icon: 'success',
                    button: 'ok',
                }).then(() => {
    ...
    //Employment Reference Check / Please share your previous Direct Manager
      const clearReferenceCheckData = () => {
        setReferenceCheckData({
            referee_id: '',
            referee_name: '',
            referee_title: '',
            referee_address: '',
    ...
    const handleFileReferInputChange = (fieldName, files) => {
        // const file = files[0]; // Assuming single file selection, update accordingly for multiple files
    ...
    const handleReferenceInputChange = (stepName, value) => {
        if (value instanceof File) {
            // Handle file input change
            handleFileEmpInputChange(stepName, [value]);
        } else {
    ...
    const saveReferenceCheck = async (e) => {
        e.preventDefault();
        const employmentData = {

           referee_id: referenceCheck.referee_id,
            referee_name: referenceCheck.referee_name,
            referee_title: referenceCheck.referee_title,
            referee_address: referenceCheck.referee_address,
            referee_contact: referenceCheck.referee_contact,
            referee_email: referenceCheck.referee_email, 
           error_list: [],
        }

        try {
            const res = await axios.post(`${apiBaseUrl}/employees/reference_check_employee`, employmentData, {
                headers: {
                    "Content-Type": "multipart/form-data"
                }
            });
            if (res.data.validator_err) {
                ...
                swal({
                    title: 'Employment Reference check added Successfully',
                    text: res.data.message,
                    icon: 'success',
                    button: 'ok',
                }).then(() => {

                    clearReferenceCheckData();
                });
            }
        } catch (error) {
            console.log('Error occurred:', error);
                ...
                <div className="box-body">
                    <form className="ti-validation" noValidate onSubmit={handleSubmit}>
                        {step === 1 && (
                            ...
                            <div className="grid lg:grid-cols-3 gap-6">
                                ...
                                <div className=" space-y-2">
                                  ...
                                  <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Employer Name  <span style={{ color: "red" }}> *</span></label>
                                 ...
                                 <div className="space-y-2">
                                    ...
                                    <input type="text" name="name_language" className="my-auto ti-form-input" placeholder="employer address" value={formData.name_language}
                                 ...
                                 <div className="space-y-2">
                                    ...
                                    <input type="text" name="name_language" className="my-auto ti-form-input" placeholder="employer contact Person" value={formData.name_language}
                                        onChange={(e) => handleInputChange('name_language', e.target.value)} required />
                                    <span className="text-danger">{formData.error_list.name_language}</span>
                                </div>
                                <div className="space-y-2">
                                 ...
                                 <div className="space-y-2">
                                    ...
                                    <div className="flex rounded-sm overflow-auto">
                                        ...
                                        <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                            name="dob" selected={formData.date_employed} onChange={(dob) => handleInputChange('dob', dob)}
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Department / Section:   <span style={{ color: "red" }}> *</span></label>
                                    <input type="text" name="present_address" className="my-auto ti-form-input" value={formData.present_address}
                                        onChange={(e) => handleInputChange('present_address', e.target.value)} placeholder="Present address" required />
                                    <span className="text-danger">{formData.error_list.present_address}</span>
                                </div>                                
                               <div className="space-y-2 multiple-select">
                                ...
                                <MultiSelect classNamePrefix='react-select' name="business" options={ExplanationSelectcomponent} value={selected} onChange={setSelected} labelledBy="Select" />
                                </div>
                        ...
                        {step === 2 && (
                            ...
                            <div className="grid lg:grid-cols-3 gap-6 second-page none" id="new_page">
                                ...
                                <MultiSelect classNamePrefix='react-select' name="key_roles" options={KeyPeoplaSelectcomponent} value={selected} onChange={setSelected} labelledBy="Select" />
                                </div>
                                 <div className="space-y-2 multiple-select">
                                <label className="ti-form-select-label mt-2">Employee Employment Conditions:</label>
                                <MultiSelect classNamePrefix='react-select' name="" options={EmploymentSelectcomponent} value={selected} onChange={setSelected} labelledBy="Select" />
                                </div>
                                 <div className="space-y-2 multiple-select">
                                <label className="ti-form-select-label mt-2">Employee Remuneration</label>
                                <MultiSelect classNamePrefix='react-select' name="" options={RemunerationSelectcomponent} value={selected} onChange={setSelected} labelledBy="Select" />
                                </div>
                                 <div className="space-y-2 multiple-select">
                                <label className="ti-form-select-label mt-2">health and safety administration:</label>
                                <MultiSelect classNamePrefix='react-select' name="" options={HealthSelectcomponent} value={selected} onChange={setSelected} labelledBy="Select" />
                                </div>
                                 <div className="space-y-2 multiple-select">
                                <label className="ti-form-select-label mt-2">Environment:</label>
                                <MultiSelect classNamePrefix='react-select' name="" options={EnvironmentSelectcomponent} value={selected} onChange={setSelected} labelledBy="Select" />
                                </div>
                                 <div className="space-y-2 multiple-select">
                                <label className="ti-form-select-label mt-2">Default MultiSelect</label>
                                <MultiSelect classNamePrefix='react-select' name="" options={AproposSelectcomponent} value={selected} onChange={setSelected} labelledBy="Select" />
                                </div>
                                 <div className="space-y-2 multiple-select">
                                <label className="ti-form-select-label mt-2">Default MultiSelect</label>
                                <MultiSelect classNamePrefix='react-select' name="" options={FollowUpSelectcomponent} value={selected} onChange={setSelected} labelledBy="Select" />
                                </div>
                                <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Date of Birth<span style={{ color: "red" }}> *</span></label>
                                    <div className="flex rounded-sm overflow-auto">
                                        <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                            <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                className="ri ri-calendar-line"></i></span>
                                        ...
                                        <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                            name="dob" selected={formData.dob} onChange={(dob) => handleInputChange('dob', dob)}
                                            timeInputLabel="Time:" dateFormat="dd/MM/yyyy h:mm aa" showTimeInput
                                        />
                                        <span className="text-danger">{formData.error_list.dob}</span>
                                    </div>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">National id <span style={{ color: "red" }}> *</span></label>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Passport id <span style={{ color: "red" }}> *</span></label>
                                ...
                                {formData.military_service === '1' && (
                                    <>
                                        ...
                                        <div className="space-y-2" id="attachment">
                                            <label className="ti-form-label mb-0 font-bold text-md ">Military Attachment (max size 2MB)</label>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Marital Ststus<span style={{ color: "red" }}> *</span></label>
                                    <div className="grid sm:grid-cols-2 gap-2">
                                        <label className="flex p-3 w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70">
                                ...
                                {formData.marital_status === '1' && (
                                    <>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Name of spouse</label>
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md ">Certificate of marriage</label>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Gender <span style={{ color: "red" }}> *</span></label>
                                    <div className="grid sm:grid-cols-2 gap-2">
                                        <label className="flex p-3 w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70">
                        ...
                        {step === 3 && (
                            <div className="grid lg:grid-cols-3 gap-6 second-page none" id="new_page">
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">	Do you have driving licence?<span style={{ color: "red" }}> *</span></label>
                                ...
                                {formData.driving_licence !== '4' && (
                                    <div className="space-y-2">
                                        <label className="ti-form-label mb-0 font-bold text-md">Place of Issued</label>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Have you ever been employed before?  <span style={{ color: "red" }}> *</span></label>
                                    <div className="grid sm:grid-cols-2 gap-2">
                                        <label className="flex p-3 w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70">
                                ...
                                {formData.employed_before === '1' && (
                                    <>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">If yes, From  </label>
                                            <div className="flex rounded-sm overflow-auto">
                                                <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                                    <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                        className="ri ri-calendar-line"></i></span>
                                                ...
                                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                                    name="from_date" selected={formData.from_date} onChange={(from_date) => handleInputChange('from_date', from_date)}
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">If yes, to</label>
                                            <div className="flex rounded-sm overflow-auto">
                                                <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                                    <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                        className="ri ri-calendar-line"></i></span>
                                                ...
                                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                                    name="to_date" selected={formData.to_date} onChange={(to_date) => handleInputChange('to_date', to_date)}
                                                    timeInputLabel="Time:" dateFormat="dd/MM/yyyy h:mm aa" showTimeInput
                                                />
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Position </label>
                                ...
                                {formData.relative_inside === '1' && (
                                    <>
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">If yes: Relative name </label>
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Relationship </label>
                        ...
                        {step === 4 && (
                            <div className="grid lg:grid-cols-3 gap-6 second-page none" id="new_page">
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Department name </label>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md" >Transfer / change date </label>
                                    <div className="flex rounded-sm overflow-auto">
                                        <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                            <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                className="ri ri-calendar-line"></i></span>
                                        ...
                                        <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                            name="transfer_change" selected={formData.transfer_change} onChange={(transfer_change) => handleInputChange('transfer_change', transfer_change)}
                                            timeInputLabel="Time:" dateFormat="dd/MM/yyyy h:mm aa" showTimeInput
                                        />
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Transfer reasons </label>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Bank Branch  <span style={{ color: "red" }}> *</span> </label>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Tin Number<span style={{ color: "red" }}> *</span>  </label>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">Nhif Number<span style={{ color: "red" }}> *</span>  </label>
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-md">When would you be able to start work<span style={{ color: "red" }}> *</span></label>
                                    <div className="flex rounded-sm overflow-auto">
                                        <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                            <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                className="ri ri-calendar-line"></i></span>
                                        ...
                                        <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                            name="readiness_employee" selected={formData.readiness_employee} onChange={(readiness_employee) => handleInputChange('readiness_employee', readiness_employee)}
                                            timeInputLabel="Time:" dateFormat="dd/MM/yyyy h:mm" showTimeInput
                                        />
                            ...
                            {step === 4 && (
                                <div className="float-end">
                                    ...
                                    <Link to="#" className="hs-dropdown-toggle py-2 px-3 ti-btn ti-btn-primary m-0 whitespace-nowrap" data-hs-overlay="#employment-history" style={{ backgroundColor: '#cbbbf2' }}>
                                        <i className="ri ri-edit-line"></i>Add Employment History
                                    </Link> &nbsp;
                                    <Link to="#" className="hs-dropdown-toggle py-2 px-3 ti-btn ti-btn-primary m-0 whitespace-nowrap" data-hs-overlay="#refernce-check" >
                                        <i className="ti ti-user-check"></i>Add Employment Reference
                                    </Link>&nbsp;
                        ...
                        <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:!mx-auto">
                            <div className="ti-modal-content ">
                                <div className="ti-modal-header">
                                    <h3 className="ti-modal-title font-bold text-md "> Education History </h3>
                                ...
                                <div className="ti-modal-body ">
                                    <div className="grid lg:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Education Level  <span style={{ color: "red" }}> *</span></label>
                                            ...
                                            <span className="text-danger">{education.error_list.education_id}</span>
                                        </div>
                                        <div className="space-y-2" id="location">
                                            <label className="ti-form-label mb-0 font-bold text-md">Location / Institute name  <span style={{ color: "red" }}> *</span></label>
                                            <Creatable
                                            ...
                                            />
                                            <span className="text-danger">{education.error_list.institute_name}</span>
                                        </div>

                                        {isOtherSelected && (
                                            <div className="space-y-2" id="other">
                                                <label className="ti-form-label mb-0 font-bold text-md">Institute Name (if any) </label>
                                                <input
                                                    type="text"
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Graduation Year<span style={{ color: "red" }}> *</span>  </label>
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Major </label>
                                            <input type="text" name="major" className="my-auto ti-form-input" value={education.major}
                                                onChange={(e) => handleEducationInputChange('major', e.target.value)} placeholder="Major name" required />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Facuty or Course or Level<span style={{ color: "red" }}> *</span> </label>
                                            <input type="text" name="course" className="my-auto ti-form-input" value={education.course}
                                                onChange={(e) => handleEducationInputChange('course', e.target.value)} placeholder="what exaclty" required />

                                        </div>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md ">Education Attachment (max size 2MB)<span style={{ color: "red" }}> *</span></label>
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md ">Special Certificate Related (max size 2MB)</label>
                                            <input type="file" name="special_cert_related" id="small-file-input"
                                                onChange={(e) => handleFilesInputChange('special_cert_related', e.target.files)} className="block w-full border border-gray-200 focus:shadow-sm dark:focus:shadow-white/10 rounded-sm text-sm focus:z-10 focus:outline-0 focus:border-gray-200 dark:focus:border-white/10 dark:border-white/10 dark:text-white/70 file:bg-transparent file:border-0 file:bg-gray-100 ltr:file:mr-4 rtl:file:ml-4 file:py-2 file:px-4 dark:file:bg-black/20 dark:file:text-white/70" />
                                        </div>
                                    </div>
                                    <br />
                                    <div className="ti-modal-footer">
                                        ...
                                        <Link className="ti-btn ti-btn-primary" to="#" onClick={SaveEducationLevel}>
                                            Create
                                        </Link>
                                    </div>
                                </div>
                    ...
                    <div id="employment-history" className="hs-overlay hidden ti-modal">
                        <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:!mx-auto">
                            <div className="ti-modal-content">
                                <div className="ti-modal-header">
                                    <h3 className="ti-modal-title mb-0 font-bold text-md"> Employment History starting with your most recent Employer </h3>
                                ...
                                <div className="ti-modal-body">
                                    <div className="grid lg:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Company Name<span style={{ color: "red" }}> *</span> </label>
                                            <input type="text" name="company_name" className="my-auto ti-form-input" value={employment.company_name}
                                                onChange={(e) => handleEmploymentInputChange('company_name', e.target.value)} placeholder="company_name" required />
                                    <span className="text-danger">{employment.error_list.company_name}</span>
                                        </div>

                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md"> From date </label>
                                            <div className="flex rounded-sm overflow-auto">
                                                <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                                    <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                        className="ri ri-calendar-line"></i></span>
                                                ...
                                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                                    name="from_date" selected={employment.from_date} onChange={(from_date) => handleEmploymentInputChange('from_date', from_date)}
                                                    timeInputLabel="Time:" dateFormat="dd/MM/yyyy h:mm aa" showTimeInput
                                                />
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">To date </label>
                                            <div className="flex rounded-sm overflow-auto">
                                                <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                                    <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                        className="ri ri-calendar-line"></i></span>
                                                ...
                                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                                    name="to_date" selected={employment.to_date} onChange={(to_date) => handleEmploymentInputChange('to_date', to_date)}
                                                    timeInputLabel="Time:" dateFormat="dd/MM/yyyy h:mm aa" showTimeInput
                                                />
                                        ...
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Position<span style={{ color: "red" }}> *</span> </label>
                                            <input type="text" name="position" className="my-auto ti-form-input" value={employment.position}
                                                onChange={(e) => handleEmploymentInputChange('position', e.target.value)} placeholder="position" required />

                                        </div>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Salary<span style={{ color: "red" }}> *</span> </label>
                                            <input type="number" name="salary" className="my-auto ti-form-input" value={employment.salary}
                                                onChange={(e) => handleEmploymentInputChange('salary', e.target.value)} placeholder="Salary" required />

                                        </div>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md ">Certificate of service (max size 2MB)</label>
                                            <input type="file" name="certificate_service" id="small-file-input"
                                                onChange={(e) => handleFileEmpInputChange('certificate_service', e.target.files)} className="block w-full border border-gray-200 focus:shadow-sm dark:focus:shadow-white/10 rounded-sm text-sm focus:z-10 focus:outline-0 focus:border-gray-200 dark:focus:border-white/10 dark:border-white/10 dark:text-white/70 file:bg-transparent file:border-0 file:bg-gray-100 ltr:file:mr-4 rtl:file:ml-4 file:py-2 file:px-4 dark:file:bg-black/20 dark:file:text-white/70" />
                                        </div>
                                    </div>
                                </div>
                                <div className="ti-modal-footer">
                                    ...
                                    <Link className="ti-btn ti-btn-primary" to="#" onClick={saveEmploymentHistory}>
                                        Create
                                    </Link>
                                </div>
                            </div>
                    ...
                    <div id="refernce-check" className="hs-overlay hidden ti-modal">
                        <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:!mx-auto">
                            <div className="ti-modal-content">
                                <div className="ti-modal-header">
                                    <h3 className="ti-modal-title  mb-0 font-bold text-md justify-center" > Employment Reference Check</h3>
                                ...
                                <div className="ti-modal-body">
                                    <div className="grid lg:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Referee <span style={{ color: "red" }}> *</span></label>
                                            <Creatable classNamePrefix="react-select" name="referee_id" options={ReferenceCheck} onChange={(selectedOption) => handleReferenceInputChange(["referee_id"], selectedOption ? selectedOption.value : null)} value={ReferenceCheck.find((option) => option.value === referenceCheck.referee_id)} />
                                            <span className="text-danger">{referenceCheck.error_list.referee_id}</span>
                                        </div>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Refere Name <span style={{ color: "red" }}> *</span></label>
                                            <input type="text" name="referee_name" className="my-auto ti-form-input" value={referenceCheck.referee_name}
                                                onChange={(e) => handleReferenceInputChange('referee_name', e.target.value)} placeholder="Referee name" required />
                                            <span className="text-danger">{referenceCheck.error_list.referee_name}</span>
                                        </div>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Referee Title<span style={{ color: "red" }}> *</span> </label>
                                            <input type="text" name="referee_title" className="my-auto ti-form-input" value={referenceCheck.referee_title}
                                                onChange={(e) => handleReferenceInputChange('referee_title', e.target.value)} placeholder="Referee title " required />
                                            <span className="text-danger">{referenceCheck.error_list.referee_title}</span>
                                        </div>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Referee Address<span style={{ color: "red" }}> *</span> </label>
                                            <input type="text" name="referee_address" className="my-auto ti-form-input" value={referenceCheck.referee_address}
                                                onChange={(e) => handleReferenceInputChange('referee_address', e.target.value)} placeholder="Referee address " required />
                                            <span className="text-danger">{referenceCheck.error_list.referee_address}</span>
                                        </div>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Referee Contact <span style={{ color: "red" }}> *</span></label>
                                            <input type="text" name="referee_contact" className="my-auto ti-form-input" value={referenceCheck.referee_contact}
                                                onChange={(e) => handleReferenceInputChange('referee_contact', e.target.value)} placeholder="Referee contact" required /><span className="text-danger">{referenceCheck.error_list.referee_contact}</span>
                                        </div>
                                        <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-md">Referee Email <span style={{ color: "red" }}> *</span></label>
                                            <input type="text" name="referee_email" className="my-auto ti-form-input" value={referenceCheck.referee_email}
                                                onChange={(e) => handleReferenceInputChange('referee_email', e.target.value)} placeholder="Referee email " required />
                                            <span className="text-danger">{referenceCheck.error_list.referee_email}</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="ti-modal-footer">
                                    ...
                                    <Link className="ti-btn ti-btn-primary" to="#" onClick={saveReferenceCheck}>
                                        Create
                                    </Link>
                                </div>
                            </div>
