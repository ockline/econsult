...
const SocialRecord = () => {
    ...
    useEffect(() => {
        const res = axios
            .get(`${apiBaseUrl}/employees/social/show_social/${id}`)
            .then(
                (res) => {
                    setEmployeeData(res.data.social_details);
                    console.log(res.data.social_details)
                },
                [id]
            );
    });
                            ...
                            <form className="printable-content">
                                <div className="flex flex-col lg:flex-row justify-between mb-5 space-y-4">
                                    <div>
                                        ...
                                        <div className="mt-1">{formData.employee_name}</div>
                                        <div className="mt-1">P.O. Box 283</div>

                                    </div>
                                    <div className="text-center">
                                        <div className="mt-1" ><h1 className="text-2xl text-black uppercase font-semibold">SOCIAL RECORD</h1> </div>
                            ...
                            {/* <div className="container" style={{ borderBottom: '2px solid black', paddingBottom: '1px' }}> */}
                                        ...
                                        <table className="w-full border-collaps">
                                            <tbody>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <label
                                                        ...
                                                        className="text-sm text-black ltr:ml-2 rtl:mr-2 dark:text-white/70"
                                                    >
                                                      Married
                                                    </label>
                                                    &nbsp;&nbsp;&nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <label
                                                        htmlFor="relative-inside-yes"
                                                        className="text-sm text-black font-medium ltr:ml-2 rtl:mr-2 dark:text-white/70"
                                                    >
                                                      Completed
                                                    </label>
                                                    &nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <label
                                                        htmlFor="relative-inside-no"
                                                        className="text-sm text-black ltr:ml-2 rtl:mr-2 font-medium dark:text-white/70"
                                                    >
                                                        Didnt Attend
                                                    </label>
                                                            </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <br />
                                 <div className="table-bordered rounded-md overflow-auto" >
                                        <h2 className="text-lg text-black font-semibold ">Relative Details</h2>
                                        <table className="ti-custom-table ti-custom-table-head" >
                                            <thead className="bg-gray-50 dark:bg-black/20" >
                                                <tr style={{ border: '2px solid black' }}>
                                                    <th scope="col" colSpan={1} className="py-3 ltr:pl-4 rtl:pr-4 text-lg text-black font-semibold " style={{ border: '2px solid black' }}>Relative name </th>
                                                    <th scope="col" colSpan={1} className="!text-center text-lg text-black font-semibold " style={{ border: '2px solid black' }}>Phone number</th>
                                                    <th scope="col" colSpan={1} className="!text-center text-lg text-black font-semibold " style={{ border: '2px solid black' }}>Relationship / Lerativeness</th>
                                                    <th scope="col" colSpan={1} className="!text-center text-lg text-black font-semibold " style={{ border: '2px solid black' }}>Relative Address</th>
                                            ...
                                            <tbody >
                                                {Array.isArray(relativeData) && relativeData.map((relative, index) => (
                                                    ...
                                                    <tr key={index} style={{ border: '2px solid black' }}>
                                                        <td colSpan={1} className="text-md font-medium text-gray-700 " style={{ border: '2px solid black' }}>{relative.relative_name}</td>
                                                        <td colSpan={1} className="text-md font-medium text-gray-700" style={{ border: '2px solid black' }}>{relative.relative_number}</td>
                                                       <td colSpan={1} className="text-md font-medium text-gray-700" style={{ border: '2px solid black' }}>
                                                            {relative.relationship_id === 16 ? (
                                                                <span>{relative.other_relationship}</span>
                                                            ) : (
                                                                <span>{relative.relationship}</span>
                                                            )}
                                                        </td>
                                                        <td colSpan={1} className="text-md font-medium text-gray-700" style={{ border: '2px solid black' }}>{relative.relative_address}</td>
                                                    </tr>
                                                ))}
                                            </tbody>
                                        </table>
                                ...
                                <br/>
                                    {/* Employment History */}
                                    <div className="table-bordered rounded-md overflow-auto" >
                                         <h3 className="text-lg text-black font-semibold ">Dependent People</h3>
                                        <table className="ti-custom-table ti-custom-table-head" >
                                            <thead className="bg-gray-50 dark:bg-black/20">
                                                <tr >
                                                    ...
                                                    <th scope="col" colSpan={1} className="!text-center text-black text-xl" style={{ border: '2px solid black' }}>Relationship / Lerativeness</th>
                                                    <th scope="col" colSpan={1} className="!text-center text-xl text-black font-semibold" style={{ border: '2px solid black' }}>Birthday</th>
                                                    <th scope="col" colSpan={1} className="!text-center text-xl text-black font-semibold" style={{ border: '2px solid black' }}>Note / Remark</th>
                                            ...
                                            <tbody>
                                                {Array.isArray(dependantData) && dependantData.map((dependant, index) => (
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td colSpan={1} className="text-md font-medium text-gray-700" style={{ border: '2px solid black' }}>{dependant.dependant_name}</td>
                                                       <td colSpan={1} className="text-md font-medium text-gray-700" style={{ border: '2px solid black' }}>{dependant.relationship_id === 16 ? (
                                                                <span>{dependant.other_relationship}</span>
                                                            ) : (
                                                                <span>{dependant.relationship}</span>
                                                            )}</td>
                                                        <td colSpan={1} className="text-md font-medium text-gray-700" style={{ border: '2px solid black' }}>{dependant.dob}</td>
                                                        <td colSpan={1} className="text-md font-medium text-gray-700" style={{ border: '2px solid black' }}>{dependant.description}</td>
