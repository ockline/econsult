    ...
    return (
        <div>
            ...
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Employees Person Details</h1>
            ...
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    ...
                    <Link to={`${import.meta.env.BASE_URL}employees/personal/add_employee`} className="ti-btn ti-btn-primary m-0 py-2"><i className="ti ti-user-plus"></i>Add New Employee</Link>
                </div>
                                        ...
                                        <tr className="product-list" key={employee.id}>
                                           ...
                                           <td>{employee.progressive_stage < 3 && (
                                            ...
                                            <td className="text-end font-medium">
                                                ...
                                                <Link
                                                    aria-label="anchor"
                                                    to={`${import.meta.env.BASE_URL}employees/personal/show_employee/` + employee.id}
                                                ...
                                                <Link
                                                    aria-label="anchor"
                                                    to={`${import.meta.env.BASE_URL}employees/personal/edit_employee/` + employee.id}
