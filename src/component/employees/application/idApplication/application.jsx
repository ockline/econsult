                                    ...
                                    currentEntries.map((employee, index) => (
                                        <tr className="product-list" key={employee.id}>
                                            ...
                                            <td className="text-center font-bold">
                                                {
                                                    employee.stage === 1 ? (<></>) :
                                                        employee.stage === 0 ? (<Link to="#" className="ti-btn ti-btn-success m-0 py-2 btn-sm" id="confirm-btn" onClick={() => Style2(employee.id)}><i className="ti ti-corner-up-right-double"  ></i>Compelete </Link>) : (<Link to={`${import.meta.env.BASE_URL}employees/applications/create_application/${employee.id}`} className="ti-btn ti-btn-primary m-0 py-2 btn-sm"><i className="ti ti-credit-card"></i>Add Personnel ID</Link>
                                                        )}</td>
