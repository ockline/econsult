...
import { TypeOfID } from "/src/common/select2data";
  ...
  setIsDocumentChecked(prevState => ({
    ...
    const handleSubmit = async (e) => {
        ...
        const DataToSend = {
            ...
            new_job_title_id: formData.new_job_title_id,
            new_department_id: formData.new_department_id,
            effective_date: formData.effective_date,
            supervisor_name: formData.supervisor_name,
            safety_induction: formData.safety_induction,
            emergency_contact_name: formData.emergency_contact_name,
            emergency_contact_number: formData.emergency_contact_number,
            manager_name: formData.manager_name,
            approval_date: formData.approval_date,
            signature: formData.signature,
            training_hr_manager: formData.training_hr_manager,
            course_study: formData.course_study,
            ...
            nida_passport_doc: formData.nida_passport_doc
            
        };
        // console.log('datatata',DataToSend)
        try {
            const resp = await axios.post(`${apiBaseUrl}/application/create_id_request`, DataToSend, {
                headers: {
        ...
        <div>
            ...
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    <h1 className="box-title my-auto font-bold text-lg"> Identification (ID) Application</h1>
                        ...
                        {step === 1 && (
                            ...
                            <div className="grid lg:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Id Type <span style={{ color: "red" }}> *</span></label>
                                    <Creatable classNamePrefix="react-select" name="id_type" options={TypeOfID} onChange={(selectedOption) => handleInputChange(["id_type"], selectedOption ? selectedOption.value : null)} value={TypeOfID.find((option) => option.value === formData.id_type)} />
                                    <span className="text-danger">{formData.error_list.id_type}</span>
                                </div>                               
                                <div className="space-y-2">
                                ...
                                {formData.id_type === '1' && (<>
                                    ...
                                    <input type="text" name="employee_no" className="my-auto ti-form-input  text-black" value={formData.employee_no}
                                        onChange={(e) => handleInputChange('employee_no', e.target.value)} placeholder="Employee Id Number" required />
                                    <span className="text-danger">{formData.error_list.employee_no}</span>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <input type="text" name="phone_number" className="my-auto ti-form-input  text-black" value={formData.phone_number}
                                        onChange={(e) => handleInputChange('phone_number', e.target.value)} placeholder="Phone Number" required />
                                 ...
                                 <div className="space-y-2">
                                    ...
                                    <input type="text" name="email_address" className="my-auto ti-form-input  text-black" value={formData.email_address}
                                        onChange={(e) => handleInputChange('email_address', e.target.value)} placeholder="Email Address" required />
                                ...
                                <div className="space-y-2">
                                 ...
                                 <div className="space-y-2" id="safety-induction">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Have you attended site safety induction? <span style={{ color: "red" }}> *</span></label>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input type="text" name="supervisor_name" className="my-auto ti-form-input text-black" value={formData.supervisor_name}
                                        onChange={(e) => handleInputChange('supervisor_name', e.target.value)} placeholder="Supervisor name" required />
                                </div>
                              </>
                                )}
                               {formData.id_type === '2' && (<>
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Employee ID No: <span style={{ color: "red" }}> *</span></label>
                                    <input type="text" name="employee_no" className="my-auto ti-form-input  text-black" value={formData.employee_no}
                                        onChange={(e) => handleInputChange('employee_no', e.target.value)} placeholder="Employee ID No" required />
                                    <span className="text-danger">{formData.error_list.employee_no}</span>
                                </div>
                                 <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">New Job Title:  <span style={{ color: "red" }}> *</span></label>
                                   <Creatable classNamePrefix="react-select" name="new_job_title_id" options={job_titles} onChange={(selectedOption) => handleInputChange(["new_job_title_id"], selectedOption ? selectedOption.value : null)} value={job_titles.find((option) => option.value === formData.new_job_title_id)} required />
                                    <span className="text-danger">{formData.error_list.new_job_title_id}</span>
                                    </div>
                                     <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">New Department:   <span style={{ color: "red" }}> *</span></label>
                                     <Creatable classNamePrefix="react-select" name="new_department_id" options={departments} onChange={(selectedOption) => handleInputChange(["new_department_id"], selectedOption ? selectedOption.value : null)} value={departments.find((option) => option.value === formData.new_department_id)} required />
                                    <span className="text-danger">{formData.error_list.new_department_id}</span>
                                    </div>
                                     <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Effective Date:   <span style={{ color: "red" }}> *</span></label>
                                     <div className="flex rounded-sm overflow-auto">
                                                <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                                    <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                        className="ri ri-calendar-line"></i></span>
                                                ...
                                                <input
                                                    type="date" name="effective_date" className="my-auto ti-form-input text-black"
                                                    placeholder="" value={new Date(formData.effective_date).toLocaleDateString('en-CA')} // Format the date
                                                    onChange={(e) => handleInputChange('effective_date', e.target.value)} required
                                                />
                                                <span className="text-danger">{formData.error_list.effective_date}</span>
                                            </div>
                                    </div>
                                     <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Supervisor Name </label>
                                ...
                                {formData.id_type === '3' && (<>
                                      ...
                                      <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Contact Person: </label>
                                    <input type="text" name="contact_person" className="my-auto ti-form-input text-black" value={formData.contact_person}
                                        onChange={(e) => handleInputChange('contact_person', e.target.value)} placeholder="Contact person" required />
                                </div>
                                     <div className="space-y-2">
                                ...
                                <div className="space-y-2" id="attachment">
                                            <label className="ti-form-label mb-0 font-bold text-lg ">NIDA or Passport Attachment <span style={{ color: "red" }}></span> </label>
                                            <input type="file" name="nida_passport_doc" id="small-file-input" onChange={(e) => handleFileInputChange('nida_passport_doc', e.target.files)} className="block w-full border border-gray-200 focus:shadow-sm dark:focus:shadow-white/10 rounded-sm text-sm focus:z-10 focus:outline-0 focus:border-gray-200 dark:focus:border-white/10 dark:border-white/10 dark:text-white/70 file:bg-transparent file:border-0 file:bg-gray-100 ltr:file:mr-4 rtl:file:ml-4 file:py-2 file:px-4 dark:file:bg-black/20 dark:file:text-white/70" />
                                        </div>
                                <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Employer / Company name  <span style={{ color: "red" }}> *</span></label>
                                 ...
                                 <div className="space-y-2">
                                    ...
                                    <span className="text-danger">{formData.error_list.emergency_contact_number}</span>
                                     ...
                                     <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Approved by </label>
                                    <input type="text" name="approved_by" className="my-auto ti-form-input text-black" value={formData.approved_by}
                                        onChange={(e) => handleInputChange('approved_by', e.target.value)} placeholder="Approver name" required />
                                    </div>
                                        <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Position </label>
                                    <input type="text" name="approver_position" className="my-auto ti-form-input text-black" value={formData.approver_position}
                                        onChange={(e) => handleInputChange('approver_position', e.target.value)} placeholder="Approver Position" required />
                                </div>
                              
                                    </>
                                )}
                                {/* Temporary site pass */}
                                    {(formData.id_type === '4' || formData.id_type === '5' )&& (<>
                                     
                                     <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Organization: </label>
                                    <input type="text" name="organization" className="my-auto ti-form-input text-black" value={formData.organization}
                                        onChange={(e) => handleInputChange('organization', e.target.value)} placeholder="Organization" required />
                                    </div>
                                      <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Contact Number: </label>
                                    <input type="text" name="contact_number" className="my-auto ti-form-input text-black" value={formData.contact_number}
                                        onChange={(e) => handleInputChange('contact_number', e.target.value)} placeholder="Contact person" required />
                                    </div>
                                      <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Host Name: </label>
                                    <input type="text" name="host_name" className="my-auto ti-form-input text-black" value={formData.host_name}
                                        onChange={(e) => handleInputChange('host_name', e.target.value)} placeholder="Host name" required />
                                </div>
                                     <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-lg">Entry Date & Time: </label>
                                            <div className="flex rounded-sm overflow-auto">
                                                <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                                    <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                        className="ri ri-calendar-line"></i></span>
                                                ...
                                                type="datetime-local"
                                                name="from_date"
                                                className="my-auto ti-form-input text-black"
                                                value={formData.from_date ? new Date(formData.from_date).toISOString().slice(0, 16) : ""}
                                ...
                                <div className="space-y-2">
                                 ...
                                 <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Purpose of Visit: <span style={{ color: "red" }}> *</span></label>
                                    <input type="text" name="purpose" className="my-auto ti-form-input  text-black" value={formData.purpose}
                                        onChange={(e) => handleInputChange('purpose', e.target.value)} placeholder="Purpose of Visit" required />
                                    <span className="text-danger">{formData.error_list.purpose}</span>
                                </div>
                                ...
                                <div className="space-y-2" id="attachment">
                                 ...
                                 <div className="space-y-2" id="safety-induction">
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-2">
                                     ...
                                     <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Security Officer:  </label>
                                    <input type="text" name="security_officer" className="my-auto ti-form-input text-black" value={formData.security_officer}
                                        onChange={(e) => handleInputChange('security_officer', e.target.value)} placeholder="Approver name" required />
                                    </div>
                                 ...
                                 {/* Traineee */}
                                    {formData.id_type === '6'&& (<>
                                     ...
                                     <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Institution Name:  </label>
                                    <input type="text" name="institution_name" className="my-auto ti-form-input text-black" value={formData.institution_name}
                                        onChange={(e) => handleInputChange('institution_name', e.target.value)} placeholder="institution_name" required />
                                    </div>
                                      <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Course of Study:  </label>
                                    <input type="text" name="course_study" className="my-auto ti-form-input text-black" value={formData.course_study}
                                        onChange={(e) => handleInputChange('course_study', e.target.value)} placeholder="Contact person" required />
                                    </div>
                                      <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">Host Name: </label>
                                    <input type="text" name="host_name" className="my-auto ti-form-input text-black" value={formData.host_name}
                                     ...
                                     <div className="space-y-2">
                                            <label className="ti-form-label mb-0 font-bold text-lg">Duration Start </label>
                                            <div className="flex rounded-sm overflow-auto">
                                                <div className="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                                    <span className="text-sm text-gray-500 dark:text-white/70"><i
                                                        className="ri ri-calendar-line"></i></span>
                                 ...
                                 <div className="space-y-2" id="safety-induction">
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <input type="text" name="supervisor_name" className="my-auto ti-form-input text-black" value={formData.supervisor_name}
                                     ...
                                     <div className="space-y-2">
                                    <label className="ti-form-label mb-0 font-bold text-lg">HR/Training Manager Name:</label>
                                    <input type="text" name="training_manager" className="my-auto ti-form-input text-black" value={formData.training_manager}
                                        onChange={(e) => handleInputChange('training_manager', e.target.value)} placeholder="Approver name" required />
                                    </div>
...
export default AddGeneralApplication;
