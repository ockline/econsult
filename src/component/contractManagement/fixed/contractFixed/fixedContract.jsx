...
import { fetchFixedContract } from "/src/common/contractsdata";
    ...
    return (
        <div>
            ...
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Employee Fixed Contracts</h1>
            ...
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    <h5 className="box-title my-auto text-lg">Fixed Contract List </h5>
                                    ...
                                    currentEntries.map((employee, index) => (
                                        <tr className="product-list" key={employee.id}>
                                            ...
                                            <td className="text-end font-medium">
                                                ...
                                                <Link
                                                    aria-label="anchor"
                                                    to={`${import.meta.env.BASE_URL}contracts/fixed/show_fixed/` + employee.employee_id}
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        if (employee.stages === 1) {
                                                            ...
                                                            navigate(`${import.meta.env.BASE_URL}contracts/fixed/edit_fixed/` + employee.employee_id);
                                                        }
                                                    }}
                                                >
