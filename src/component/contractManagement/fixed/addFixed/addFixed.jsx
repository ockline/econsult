...
const AddFixedContract = () => {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`${apiBaseUrl}/contracts/fixed/get_fixed_contract/${id}`).then((res) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const resp = await axios.post(`${apiBaseUrl}/contracts/fixed/add_fixed_contract`, DataToSend, {
                headers: {
...
export default AddFixedContract;
