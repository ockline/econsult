    ...
    return (
        <div>
            ...
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Show Employee Term and Conditions</h1>
                                        ...
                                        <div className="pb-5">
                                            <div className="md:flex justify-between space-y-2 md:space-y-0">
                                                ...
                                                <div className="md:ltr:ml-auto md:rtl:mr-auto">
                                                    ...
                                                    <Link
                                                        aria-label="anchor"
                                                        to={`${import.meta.env.BASE_URL}contracts/terms/download_term_condition/` + formData.employee_id}
                                                        className="hs-dropdown-toggle py-2 px-3 ti-btn ti-btn-success w-full"
                                                        style={{ backgroundColor: '#7800ff' }}
                                                    >
                                                        <i className="ti ti-cloud-download"></i>Download Term and Condition
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
...
export default ShowTermCondition;
