...
const AddSpecifiTaskContract = () => {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`${apiBaseUrl}/contracts/specific/get_specific_task/${id}`).then((res) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const resp = await axios.post(`${apiBaseUrl}/contracts/specific/add_specific_task`, DataToSend, {
                headers: {
    ...
    return (
        <div>
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Employee Specific Task Contract</h1>
                ...
                <ol className="flex items-center whitespace-nowrap min-w-0 text-end">
                    ...
                    <li className="text-sm">
                        <a className="flex items-center text-primary hover:text-primary dark:text-primary" href={`${import.meta.env.BASE_URL}contracts/specific/add_specific_task/${formData.id}`}>
                            Add Specitic Task
                            {/* <i className="ti ti-chevrons-right flex-shrink-0 mx-3 overflow-visible text-gray-300 dark:text-white/10 rtl:rotate-180"></i> */}
                        </a>
                    </li>
            ...
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    <h1 className="box-title my-auto font-bold text-lg">Add Specific Task Contract</h1>
                            ...
                            <div className="grid lg:grid-cols-3 gap-6 second-page none" id="new_page">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex rounded-sm overflow-auto">
                                        ...
                                        <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                            name="working_from" selected={formData.working_from} onChange={(date) => handleInputChange('working_from', date)} timeIntervals={15}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex rounded-sm overflow-auto">
                                        ...
                                        <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                            name="working_to" selected={formData.working_to} onChange={(date) => handleInputChange('working_to', date)} timeIntervals={15}
                                            timeCaption="Time" dateFormat="h:mm aa" showTimeInput showTimeSelectOnly
                                        />
                                    ...
                                    <>
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex rounded-sm overflow-auto">
                                                ...
                                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                                    name="night_working_from" selected={formData.night_working_from} onChange={(date) => handleInputChange('night_working_from', date)} timeIntervals={15}
                                                    timeCaption="Time" dateFormat="h:mm aa" showTimeInput showTimeSelectOnly
                                                />
                                                <span className="text-danger">{formData.error_list.night_working_from}</span>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex rounded-sm overflow-auto">
                                                ...
                                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                                    name="night_working_to" selected={formData.night_working_to} onChange={(date) => handleInputChange('night_working_to', date)} timeIntervals={15}
                                                    timeCaption="Time" dateFormat="h:mm aa" showTimeInput showTimeSelectOnly
                                                />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex rounded-sm overflow-auto">
                                        ...
                                        <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                            name="saturday_from" selected={formData.saturday_from} onChange={(date) => handleInputChange('saturday_from', date)} timeIntervals={15}
                                            timeCaption="Time" dateFormat="h:mm aa" showTimeInput showTimeSelectOnly
                                        />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex rounded-sm overflow-auto">
                                        ...
                                        <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10"
                                            name="saturday_to" selected={formData.saturday_to} onChange={(date) => handleInputChange('saturday_to', date)}
                                            timeCaption="Time" dateFormat="h:mm aa" showTimeInput showTimeSelectOnly timeIntervals={15}
                                        />
                            ...
                            {step === 2 && (
                                <div className="float-end">
                                    <button type="button" onClick={handleSubmit} className="ti-btn ti-btn-success  justify-center">
                                        <i className="ti ti-corner-up-right-double"></i>Submit Specific Contract
                                    </button>
                                </div>
                            )}
                        </div>
...
export default AddSpecifiTaskContract;
