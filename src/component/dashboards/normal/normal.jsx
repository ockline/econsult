...
const Normal = (props) => {
    ...
    useEffect(() => {
        axios
            .get(`${apiBaseUrl}/home/normal/show_employees`)
            .then((res) => {
                        ...
                        <div className="box-body p-0">
                            <div className="grid grid-cols-12">
                                <div className="col-span-12  sm:col-span-6 xl:col-span-3 sm:border-b-0 ltr:border-r rtl:border-l border-b border-gray-200 dark:border-white/10">
                                    <div className="flex flex-wrap p-6 items-center">
                                        <div className="ltr:mr-3 rtl:ml-3 leading-none">
                                            <span className="avatar inline-flex justify-center items-center rounded-full bg-primary/20 text-primary shadow-sm">
                                                <i className="ti ti-package text-lg"></i>
                                            </span>
                                        </div>
                                        <div className="flex-1 font-semibold">
                                            <div className="flex justify-between items-center mb-2">
                                                <p className="mb-0 text-gray-800 dark:text-white">
                                                    Total Active{" "}
                                                </p>
                                                <span>200</span>
                                            </div>
                                            ...
                                            <Link
                                                to="#"
                                                className="text-gray-500 dark:text-white/70 text-xs flex"
                                            >
                                                Full Details
                                                <i className="ri-arrow-right-s-line ltr:ml-2 rtl:mr-2"></i>
                                            </Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-span-12  sm:col-span-6 xl:col-span-3 sm:border-b-0 ltr:border-r rtl:border-l border-b border-gray-200 dark:border-white/10">
                                    <div className="flex flex-wrap p-6 items-center">
                                        <div className="ltr:mr-3 rtl:ml-3 leading-none">
                                            <span className="avatar inline-flex justify-center items-center rounded-full bg-secondary/20 text-secondary shadow-sm">
                                        ...
                                        <div className="flex-1 font-semibold">
                                            ...
                                            <div className="ti-main-progress bg-gray-200 dark:bg-black/20 mb-2">
                                                <div
                                                    className="ti-main-progress-bar bg-secondary text-xs text-white text-center"
                                                    role="progressbar"
                                                    style={{ width: "75%" }}
                                                    aria-valuenow="75"
                                                    aria-valuemin="0"
                                ...
                                <div className="col-span-12  sm:col-span-6 xl:col-span-3 sm:border-b-0 ltr:border-r rtl:border-l border-b border-gray-200 dark:border-white/10">
                                    <div className="flex flex-wrap p-6 items-center">
                                        <div className="ltr:mr-3 rtl:ml-3 leading-none">
                                            <span className="avatar inline-flex justify-center items-center rounded-full bg-danger/20 text-danger shadow-sm">
                                        ...
                                        <div className="flex-1 font-semibold">
                                            ...
                                            <div className="ti-main-progress bg-gray-200 dark:bg-black/20 mb-2">
                                                <div
                                                    className="ti-main-progress-bar bg-warning text-xs text-white text-center"
                                                    style={{ width: "75%" }}
                                                    role="progressbar"
                                                    aria-valuenow="75"
                                                    aria-valuemin="0"
                                ...
                                <div className="col-span-12  sm:col-span-6 xl:col-span-3">
                                    <div className="flex flex-wrap p-6 items-center">
                                        <div className="ltr:mr-3 rtl:ml-3 leading-none">
                                            <span className="avatar inline-flex justify-center items-center rounded-full bg-info/20 text-info shadow-sm">
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td className="text-end font-medium">
                                                            ...
                                                            <Link
                                                                aria-label="anchor"
                                                                to={
                                                                    `${import.meta.env.BASE_URL}employees/applications/show_application/` +
                                                                    employee.id
                                                                }
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={() => {
                                                                    if (
                                                                        ...
                                                                        navigate(
                                                                            `${import.meta.env.BASE_URL}employees/applications/edit_application/` +
                                                                                employee.id,
                                                                        );
                                                                    }
                                                                }}
