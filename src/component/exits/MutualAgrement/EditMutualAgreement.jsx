  ...
  const handleSubmit = async (values, action = 'save') => {
    ...
    try {
      ...
      const endpoint = action === 'submit' 
        ? `${apiBaseUrl}/employees/exits/mutual_agreement/submit_mutual_agreement/${id}`
        : `${apiBaseUrl}/employees/exits/mutual_agreement/update_mutual_agreement/${id}`;
  ...
  return (
    <div>
      ...
      <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Edit Mutual Agreement</h1>
...
export default EditMutualAgreement;
