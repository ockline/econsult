  ...
  const handleSubmit = async (values, action = 'save') => {
    ...
    try {
      ...
      const endpoint = action === 'submit' 
        ? `${apiBaseUrl}/employees/exits/endcontract/submit_endcontract/${id}`
        : `${apiBaseUrl}/employees/exits/endcontract/update_endcontract/${id}`;
  ...
  return (
    <div>
      ...
      <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Edit End Contract</h1>
...
export default EditEndContract;
