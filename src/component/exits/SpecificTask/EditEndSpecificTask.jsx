  ...
  const handleSubmit = async (values, action = 'save') => {
    ...
    try {
      ...
      const endpoint = action === 'submit' 
        ? `${apiBaseUrl}/employees/exits/end_specific_contract/submit_end_specific_contract/${id}`
        : `${apiBaseUrl}/employees/exits/end_specific_contract/update_end_specific_contract/${id}`;
  ...
  return (
    <div>
      ...
      <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Edit End Specific Task Contract</h1>
...
export default EditEndSpecificTask;
