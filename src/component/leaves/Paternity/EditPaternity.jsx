...
const EditPaternity = () => {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`${apiBaseUrl}/leaves/retrieve_paternity_detail/${id}`).then((res) => {
 ...
 const [isLoading, setIsLoading] = useState(false);
    const handleSubmit = async (e) => {
        ...
        try {
            const resp = await axios.post(`${apiBaseUrl}/leaves/update_paternity_leave/${id}`, DataToSend, {
                headers: {
