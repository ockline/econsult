...
const EditMaternity = () => {
 ...
 const [isLoading, setIsLoading] = useState(false);
    const handleSubmit = async (e) => {
        ...
        try {
            const resp = await axios.post(`${apiBaseUrl}/leaves/update_maternity_leave/${id}`, DataToSend, {
                headers: {
            ...
            if (resp.data.validator_err) {
                ...
                .then(() => {
                navigate('/leaves/maternity_leave/'); 
                });
            }
        }
        catch (error) {
        ...
        <div>
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <ol className="flex items-center whitespace-nowrap min-w-0 text-end">
                    ...
                    <li className="text-sm">
                        <a className="flex items-center text-primary hover:text-primary dark:text-primary" href={`${import.meta.env.BASE_URL}leaves/maternity/edit_maternity_leave/${formData.id}`}>
                            Edit Maternity Leave
                            {/* <i className="ti ti-chevrons-right flex-shrink-0 mx-3 overflow-visible text-gray-300 dark:text-white/10 rtl:rotate-180"></i> */}
                        </a>
                    </li>
                </ol>
            ...
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    ...
                    <Link to={`${import.meta.env.BASE_URL}leaves/maternity/`} className="ti-btn ti-btn-primary m-0 py-2"><i className="ti ti-arrow-left"></i>Back</Link>
                </div>
