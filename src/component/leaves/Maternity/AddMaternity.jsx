...
import { MaternityLeave } from "/src/common/select2data";
  ...
  // Handle changes in form input
    ...
    const handleSubmit = async (e) => {
        ...
        const DataToSend = {
         ...
         setIsLoading(true);
    try {
      const resp = await axios.post(`${apiBaseUrl}/leaves/create_maternity_leave`, DataToSend, {
        headers: {
    ...
    return (
        <div>
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Create Maternity Leave</h1>
                        ...
                        {step === 1 && (
                            ...
                            <div className="grid lg:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Creatable classNamePrefix="react-select" name="leave_type" options={MaternityLeave} onChange={(selectedOption) => handleInputChange(["leave_type"], selectedOption ? selectedOption.value : null)} value={MaternityLeave.find((option) => option.value === formData.leave_id)} />
