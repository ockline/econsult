...
const EditCompassionate = () => {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`${apiBaseUrl}/leaves/retrieve_compassionate_detail/${id}`).then((res) => {
            // Ensure that all properties are present in the API response
            const updatedFormData = {
                ...formData,
                ...res.data.compassionate,
            };
 ...
 const [isLoading, setIsLoading] = useState(false);
    const handleSubmit = async (e) => {
        ...
        try {
            const resp = await axios.post(`${apiBaseUrl}/leaves/update_compassionate_leave/${id}`, DataToSend, {
                headers: {
    ...
    return (
        <div>
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Employee Leave Management</h1>

                <ol className="flex items-center whitespace-nowrap min-w-0 text-end">
                    <li className="text-sm">
                        <a className="flex items-center text-primary hover:text-primary dark:text-primary" href={`${import.meta.env.BASE_URL}leaves/compassionate/`}>
                            Home
                            <i className="ti ti-chevrons-right flex-shrink-0 mx-3 overflow-visible text-gray-300 dark:text-white/10 rtl:rotate-180"></i>
                        </a>
                    </li>
                    <li className="text-sm">
                        <a className="flex items-center text-primary hover:text-primary dark:text-primary" href={`${import.meta.env.BASE_URL}leave/compassionate/edit_compassionate_leave/${formData.id}`}>
                            Edit Compassionate
                            {/* <i className="ti ti-chevrons-right flex-shrink-0 mx-3 overflow-visible text-gray-300 dark:text-white/10 rtl:rotate-180"></i> */}
                        </a>
                    </li>
            ...
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    ...
                    <Link to={`${import.meta.env.BASE_URL}leaves/compassionate/`} className="ti-btn ti-btn-primary m-0 py-2"><i className="ti ti-arrow-left"></i>Back</Link>
                </div>
                            ...
                            <div className="grid lg:grid-cols-3 gap-6">
                              ...
                              <div className="space-y-2">
                                    ...
                                    <div className="flex rounded-sm overflow-auto">
                                        ...
                                        <input
                                            type="date" name="dob" className="my-auto ti-form-input text-black  border-red-500 text-lg"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex rounded-sm overflow-auto">
                                        ...
                                        <input
                                            type="date" name="end_date" className="my-auto ti-form-input text-black  border-red-500 text-lg"
...
export default EditCompassionate;
