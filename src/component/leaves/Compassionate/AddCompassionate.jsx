...
import { CompassionateLeave } from "/src/common/select2data";
import axios from "axios";
import Swal from "sweetalert2";



const AddCompassionate = () => {
  ...
  // Handle changes in form input
    ...
    const handleSubmit = async (e) => {
        ...
        const DataToSend = {
         ...
         setIsLoading(true);
    try {
      const resp = await axios.post(`${apiBaseUrl}/leaves/create_compassionate_leave`, DataToSend, {
        headers: {
    ...
    return (
        <div>
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Create Compassionate Leave</h1>
                        ...
                        {step === 1 && (
                            ...
                            <div className="grid lg:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Creatable classNamePrefix="react-select" name="leave_type" options={CompassionateLeave} onChange={(selectedOption) => handleInputChange(["leave_type"], selectedOption ? selectedOption.value : null)} value={CompassionateLeave.find((option) => option.value === formData.leave_id)} />
...
export default AddCompassionate;
