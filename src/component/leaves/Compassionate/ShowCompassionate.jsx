...
const ShowCompassionate = () => {
    ...
    useEffect(() => {
        axios.get(`${apiBaseUrl}/leaves/retrieve_compassionate_detail/${id}`)
            .then((res) => {
                // console.log('API Response:', res.data);  // Log the entire response
                setEmployeeData(res.data.compassionate);
    ...
    return (
        <div>
            ...
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Show Compassionate Leave</h1>
                ...
                <ol className="flex items-center whitespace-nowrap min-w-0 text-end">
                    ...
                    <li className="text-sm">
                        <a className="flex items-center text-primary hover:text-primary dark:text-primary" href={`${import.meta.env.BASE_URL}leaves/compassionate/show_compassionate_leave/${formData.id}`}>Show Compassionate Leave
...
export default ShowCompassionate;
