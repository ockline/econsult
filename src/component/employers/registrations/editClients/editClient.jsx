...
const { id } = useParams();
        useEffect(() => {
    axios.get(`${apiBaseUrl}/employers/edit_employer/${id}`).then((res) => {
    ...
    <div>
        ...
        <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12">
                <div className="box">
                        <div className="box-header">
                            ...
                            <h5 className="box-title">Update Employer Details</h5>
            ...
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
				<h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}> Edit Employer Details</h1>
				...
				<ol className="flex items-center whitespace-nowrap min-w-0 text-end">
					...
					<li className="text-sm">
					<a className="flex items-center text-primary hover:text-primary dark:text-primary" href={`${import.meta.env.BASE_URL}employers/registrations/editClients/` + formData.id}>
						Add New Employer
					</a>
					</li>
				</ol>
				...
				<div className= "box-header lg:flex lg:justify-between">
					<h1 className= "box-title my-auto">Update Employer Details</h1>
                    ...
                    <div className="box-body">
                        <form className="ti-validation" noValidate onSubmit={updateEmployer}>
                                {step === 1 && (
								...
								<span className="badge py-0.5 px-1.5 bg-black/50 text-white">1</span>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input type="text" className="my-auto ti-form-input" placeholder="alias" name="alia"  value={formData.alia}
                                            onChange={(e) => handleInputChange('alia', e.target.value)}  />
                                        </div>
                                        <div className="space-y-2">
                         ...
                         <br/>
                            ...
                            {step === 3 && (
                                ...
                                <button type="button" onClick={updateEmployer} className="ti-btn ti-btn-success  justify-center">
