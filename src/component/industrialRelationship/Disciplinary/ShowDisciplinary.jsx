...
const ShowDisciplinary = () => {
    ...
    .then((res) => {
        if (res.data.status === 404) {
            ...
            setEmployeeData(res.data.disciplinary); // ✅ store only disciplinary object
        }
    })
    .catch((error) => {
    ...
    return (
        <div>
            ...
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Show Disciplinary Details </h1>
                ...
                <ol className="flex items-center whitespace-nowrap min-w-0 text-end">
                    ...
                    <li className="text-sm">
                        <a className="flex items-center text-primary hover:text-primary dark:text-primary" href={`${import.meta.env.BASE_URL}industrial/disciplinary/show_disciplinary/${formData.id}`}>Show Disciplinary Details
                        </a>
                    </li>
                </ol>
            </div>
                                        ...
                                        <div className="pb-5">
                                            <div className="md:flex justify-between space-y-2 md:space-y-0">
                                                ...
                                                <div className="md:ltr:ml-auto md:rtl:mr-auto">
                                                    ...
                                                    >
                                                        <i className="ti ti-cloud-download"></i>Download Charge Sheet
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
...
export default ShowDisciplinary;
