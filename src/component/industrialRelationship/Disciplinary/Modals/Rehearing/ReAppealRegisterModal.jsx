...
export  function ReAppealREgisterModal({ isOpen, onClose }) {
    ...
    <div className="flex justify-between items-center border-b pb-3 mb-4">
      ...
      <button onClick={onClose} className="text-gray-600 hover:text-black">
                        ...
                        {step === 1 && (
                            ...
                            ></textarea>
                                 ...
                                 <div className="space-y-2">
                                            ...
                                            onChange={(e) => handleFileInputChange('investigator_signature', e.target.files)} className="block w-full border border-gray-200 focus:shadow-sm dark:focus:shadow-white/10 rounded-sm text-sm focus:z-10 focus:outline-0 focus:border-gray-200 dark:focus:border-white/10 dark:border-white/10 dark:text-white/70 file:bg-transparent file:border-0 file:bg-gray-100 ltr:file:mr-4 rtl:file:ml-4 file:py-2 file:px-4 dark:file:bg-black/20 dark:file:text-white/70" required/>
                                </div>
        ...
        {/* <div className="flex justify-end space-x-2">
          ...
          <button className="ti-btn ti-btn-primary">Save changes</button>
        </div> */}
      </div>
    </div>
...
export default ReAppealREgisterModal;
