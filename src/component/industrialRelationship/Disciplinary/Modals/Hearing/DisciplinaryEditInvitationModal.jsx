...
export  function DisciplinaryEditInvitationModal({ isOpen, onClose }) {
  ...
  >
    <div className="flex justify-between items-center border-b pb-3 mb-4">
      <h3 className="text-lg font-semibold">Create Disciplinary Invitation</h3>
...
export default DisciplinaryInvitationModal;
