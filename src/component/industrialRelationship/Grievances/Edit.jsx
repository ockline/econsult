  ...
  // Handle changes in form input
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (res.data.status === 404) {
                    ...
                    setFormData(res.data.grievance);
                }
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        const token = sessionStorage.getItem('token');
         setIsLoading(true);
    try {
      const resp = await axios.post(`${apiBaseUrl}/industrial_relationship/grievances/update_grievance`, DataToSend, {
          headers: {
             'Authorization': `Bearer ${token}`,
    ...
    return (
        <div>
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h1 style={{ fontWeight: 'bold', fontSize: '2em', margin: 0 }}>Update Grievance</h1>
            ...
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    <h1 className="box-title my-auto font-bold text-lg">Edit Grievance</h1>
                            ...
                            <div className="grid lg:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input type="text" name="middlename" className="my-auto ti-form-input text-black bg-gray-100 border-red-500 text-md" placeholder="Middlename" value={formData?.middlename} readOnly
                                        onChange={(e) => handleInputChange('middlename', e.target.value)} r/>
