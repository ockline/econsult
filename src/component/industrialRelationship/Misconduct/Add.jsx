                        ...
                        {step === 1 && (
                            ...
                            <div className="grid lg:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Creatable classNamePrefix="react-select" name="misconduct_cause" options={misconductTypes} onChange={(selectedOption) => handleInputChange(["misconduct_cause"], selectedOption ? selectedOption.value : null)} value={misconductTypes.find((option) => option.value === formData.id)} />
                               ...
                               <div className="space-y-2">
                                ...
                                <div className="flex rounded-sm overflow-auto">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => handleInputChange('misconduct_date', e.target.value)} 
                                        required
                                    />
