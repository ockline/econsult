...
const ShowCapacity = () => {
    ...
    useEffect(() => {
        axios.get(`${apiBaseUrl}/industrial_relationship/show_performance_capacity/${id}`)
            .then((res) => {
                // console.log('API Response:', res.data);  // Log the entire response
                setEmployeeData(res.data.show_capacity);
        ...
        <div>
            ...
            <div className="box-body" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <ol className="flex items-center whitespace-nowrap min-w-0 text-end">
                    ...
                    <li className="text-sm">
                        <a className="flex items-center text-primary hover:text-primary dark:text-primary" href={`${import.meta.env.BASE_URL}industrials/show_performance_capacity/${formData.employee_id}`}>Show Preformance Capacity
