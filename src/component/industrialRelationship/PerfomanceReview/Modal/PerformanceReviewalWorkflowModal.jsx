...
const PerformanceReviewalWorkFlowModal = ({ workflows, formData }) => {
    ...
    try {
        ...
        const response = await axios.post(
            `${apiBaseUrl}/industrial_relationship/performance_reviews/review_performance_workflow`,
            updatedValues,
            {
                headers: {
        ...
        if (response.data.status === 200) {
            await swal({
                title: "Success",
                text: "Performance Review successfully reviewed.",
                icon: "success",
                button: "Close",
            });
    ...
    return (
     ...
     <Row gutter={[16, 16]}>
                              ...
                              <Form form={reviewForm} layout="vertical">
                                   <Col span={24}>
                                    <Form.Item label="Review Decision" name="review_decision">
                                    <Select
                                ...
                                <Col span={24}>
                                    <Form.Item label="Comments" name="comments">
                                        <Input.TextArea 
                                            rows={3}
                                            placeholder="Enter your review comments and recommendations" 
                                        />
                                    </Form.Item>
                                </Col>
...
export default PerformanceReviewalWorkFlowModal;
