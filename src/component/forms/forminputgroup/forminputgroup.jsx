                ...
                <div className = "grid grid-cols-12 gap-x-6">
                    ...
                    <div className = "col-span-12 md:col-span-6 xxl:!col-span-3">
                        <div className = "box">
                            ...
                            <div className = "box-body">
                                <div>
                                    <label htmlFor="hs-input-with-add-on-url" className = "block text-sm text-gray-700 font-medium dark:text-white">System URL</label>
                                    <div className = "flex rounded-sm">
                ...
                <div className = "grid grid-cols-12 gap-x-6">
                    <div className = "col-span-12 md:col-span-6 xxl:!col-span-3">
                        <div className = "box">
                            ...
                            <div className = "box-body">
                                <div>
                                    <label htmlFor="hs-inline-add-on" className = "ti-form-label">System URL</label>
                                    <div className = "relative">
